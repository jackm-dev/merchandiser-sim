...
- Clear, detailed, thorough labeling defeats distortion
- Show data variation, not design variation
- In time-series displays, standardize money (deflate) and use consistent baselines
- Dimensions of graphics should not exceed dimensions of data
...
- Erase non-data-ink (decoration, heavy grids, boxes)
- Erase redundant data-ink (3D when 2D suffices)
- Revise and edit
...
- **Data-Ink:** Can I erase any element without losing data? (Erase it)
- **Integrity:** Does the visual effect match the data effect? (Lie Factor ≈ 1)
- **Chartjunk:** Does any element exist for decoration only? (Remove it)
- **Excellence:** Does it reveal the data at multiple levels? (Broad + detailed)
- **Comparison:** Can the viewer easily compare data elements? (Enable it)
- **Density:** Could this show more data in the same space? (Condense)
- **Context:** Is all necessary context provided? (Labels, sources, scales)
